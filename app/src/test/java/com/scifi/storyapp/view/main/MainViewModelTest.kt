...
import com.scifi.storyapp.utils.DataDummy
import com.scifi.storyapp.utils.MainDispatcherRule
import com.scifi.storyapp.utils.getOrAwaitValue
...
class MainViewModelTest {
    ...
    fun `when Get Story Should Not Null and Return Data`() = runTest {
        ...
        Mockito.`when`(storyRepository.getStoriesPager()).thenReturn(expectedStory)
